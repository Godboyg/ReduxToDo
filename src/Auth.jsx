    ...
    <div className="shadow-md">
      {isAuthenticated ? (
        ...
        <div className="px-[3vw] py-[4vw] h-[90vh] w-full shadow-lg">
          ...
          <div className={`flex items-center justify-center absolute top-55 shadow-lg left-5 transition-all duration-300 ease-in-out transform ${taskvisible ? "opacity-100 scale-100 z-50" : "opacity-0 z-20 scale-90"}`}>
